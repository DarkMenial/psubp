      ...
      <nav>
        ...
        <div class="header__nav-list">
          ...
          <ul class="secondary-list">
              ...
              <a href="../../psubp/about.php">About</a>
                <ul class="dropdown">
                  ...
                  <li><a href="../../psubp/about.php#history" data-section="history">History</a></li>
                      ...
                      <li><a href="../../psubp/about.php#organizationl-chart">Organizational Chart</a></li>
            ...
            <li>
              <a href="../../psubp/directory.php">Directory</a>
            </li>
          </ul>
          <!-- Main NavList (lower) -->
          <ul class="main-list">
            ...
            <li>
              ...
              <ul class="dropdown">
                ...
                <li><a href="../../psubp/admission_programs.php">Programs Offered</a></li>
                <li><a href="../../psubp/academics.php#undergraduate-programs">Programs Head</a></li>  
